...
namespace Assets.Scripts.Game
{
    ...
    public class CurrentStateWorldModelImproved : FutureStateWorldModelImproved
    {
        private Dictionary<string, Goal> Goals { get; set; } 

        public CurrentStateWorldModelImproved(GameManager gameManager, List<Action> actions, List<Goal> goals) : base(gameManager, actions)
        {
            this.Parent = null;
        ...
        {
            //this method does nothing, because you should not directly set a goal value of the CurrentStateWorldModelImproved
        }

        public override void SetProperty(string propertyName, object value)
        {
            //this method does nothing, because you should not directly set a property of the CurrentStateWorldModelImproved
        }
